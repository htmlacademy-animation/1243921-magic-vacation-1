...
/***/ "./source/js/modules/crocodile-scene.js":
/*!**********************************************!*\
  !*** ./source/js/modules/crocodile-scene.js ***!
  \**********************************************/
/*! exports provided: default */
...
/* harmony import */ var _helpers_animate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers/animate */ "./source/js/modules/helpers/animate.js");
/* harmony import */ var _helpers_canvas__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers/canvas */ "./source/js/modules/helpers/canvas.js");
/* harmony import */ var _helpers_easings__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers/easings */ "./source/js/modules/helpers/easings.js");
...
class CrocodileScene extends _helpers_canvas__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor() {
    const canvas = document.getElementById(`result-canvas3`);
  ...
  initAnimations() {
    this.animations.push(new _helpers_animate__WEBPACK_IMPORTED_MODULE_0__["default"]({
      func: () => {
        this.drawScene();
      },
      duration: `infinite`,
  ...
  initCrocodileAnimations() {
    ...
    this.animations.push(new _helpers_animate__WEBPACK_IMPORTED_MODULE_0__["default"]({
      func: (progress) => {
        ...
        o.transforms.rotate = 31 * progressReversed;
        o.transforms.translateX = 55 * progressReversed - 6;
        o.transforms.translateY = 8 * progress;
      },
      duration: 1000,
      delay: this._DELAY_START + 1300,
      easing: _helpers_easings__WEBPACK_IMPORTED_MODULE_2__["default"].easeOutCubic,
      callback: () => {
  ...
  initDropAnimations() {
    ...
    let animation = new _helpers_animate__WEBPACK_IMPORTED_MODULE_0__["default"]({
      func: (progress) => {
        const progressReversed = 1 - progress;
      ...
      easing: _helpers_easings__WEBPACK_IMPORTED_MODULE_2__["default"].easeInCubic,
    });
...
/* harmony import */ var _game_ticker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./game-ticker */ "./source/js/modules/game-ticker.js");
/* harmony import */ var _prize__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./prize */ "./source/js/modules/prize.js");
...
class FullPageScroll {
  ...
  changeVisibilityDisplay() {
    ...
    if (this.screenElements[this.activeScreen].classList.contains(`screen--prizes`)) {
      ...
      if (firstCall) {
        firstCall = false;
        Object(_prize__WEBPACK_IMPORTED_MODULE_2__["startNumbersTicker"])();
      } else {
        Object(_prize__WEBPACK_IMPORTED_MODULE_2__["resetNumbersTicker"])();
      }
    ...
    if (this.screenElements[this.activeScreen].classList.contains(`screen--game`)) {
      Object(_game_ticker__WEBPACK_IMPORTED_MODULE_1__["startTicker"])();
    } else {
      Object(_game_ticker__WEBPACK_IMPORTED_MODULE_1__["resetTicker"])();
    }
  }
...
/***/ "./source/js/modules/game-ticker.js":
/*!******************************************!*\
  !*** ./source/js/modules/game-ticker.js ***!
  \******************************************/
/*! exports provided: startTicker, resetTicker */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "startTicker", function() { return startTicker; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "resetTicker", function() { return resetTicker; });
/* harmony import */ var _ticker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ticker */ "./source/js/modules/ticker.js");
...
const ticker = new _ticker__WEBPACK_IMPORTED_MODULE_0__["default"](mins, secs, 5);
...
/***/ "./source/js/modules/helpers/animate.js":
/*!**********************************************!*\
  !*** ./source/js/modules/helpers/animate.js ***!
  \**********************************************/
/*! exports provided: default */
...
/* harmony import */ var _easings_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./easings.js */ "./source/js/modules/helpers/easings.js");
...
class Animation {
  constructor(options) {
    ...
    if (!this.options.easing) {
      this.options.easing = _easings_js__WEBPACK_IMPORTED_MODULE_0__["default"].easeLinear;
    }
...
/***/ "./source/js/modules/helpers/canvas.js":
/*!*********************************************!*\
  !*** ./source/js/modules/helpers/canvas.js ***!
  \*********************************************/
/*! exports provided: default */
...
/***/ "./source/js/modules/letters-anim.js":
/*!*******************************************!*\
  !*** ./source/js/modules/letters-anim.js ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  const animationDateTextLine = new AccentTypographyBuild(`.intro__date`, 500, `active`, `transform`);
  setTimeout(() => {
...
/***/ "./source/js/modules/numberFrameTicker.js":
/*!************************************************!*\
  !*** ./source/js/modules/numberFrameTicker.js ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return NumberFrameTicker; });
class NumberFrameTicker {
...
/***/ "./source/js/modules/prize.js":
/*!************************************!*\
  !*** ./source/js/modules/prize.js ***!
  \************************************/
/*! exports provided: startNumbersTicker, resetNumbersTicker */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "startNumbersTicker", function() { return startNumbersTicker; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "resetNumbersTicker", function() { return resetNumbersTicker; });
/* harmony import */ var _numberFrameTicker_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./numberFrameTicker.js */ "./source/js/modules/numberFrameTicker.js");
...
let startNumbersTicker = () => {
  for (let index = 1; index < containers.length; index++) {
    setTimeout(() => {
      new _numberFrameTicker_js__WEBPACK_IMPORTED_MODULE_0__["default"](containers[index], startNubers[index], endNumbers[index], steps[index]).start();
    }, timings[index]);
  }
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _sea_calf_scene_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sea-calf-scene.js */ "./source/js/modules/sea-calf-scene.js");
/* harmony import */ var _crocodile_scene_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./crocodile-scene.js */ "./source/js/modules/crocodile-scene.js");
    ...
    for (let i = 0; i < showResultEls.length; i++) {
      showResultEls[i].addEventListener(`click`, function () {
        ...
        switch (i) {
          case 0:
            /* eslint-disable */
            const calf = new _sea_calf_scene_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
            /* eslint-enable */
          ...
          case 2:
            /* eslint-disable */
            const resultScene = new _crocodile_scene_js__WEBPACK_IMPORTED_MODULE_1__["default"](); 
            /* eslint-enable */
...
/***/ "./source/js/modules/sea-calf-scene.js":
/*!*********************************************!*\
  !*** ./source/js/modules/sea-calf-scene.js ***!
  \*********************************************/
/*! exports provided: default */
...
/* harmony import */ var _helpers_animate_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers/animate.js */ "./source/js/modules/helpers/animate.js");
/* harmony import */ var _helpers_canvas_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers/canvas.js */ "./source/js/modules/helpers/canvas.js");
/* harmony import */ var _helpers_easings_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers/easings.js */ "./source/js/modules/helpers/easings.js");
...
class SeaCalfScene extends _helpers_canvas_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor() {
  ...
  initAnimations() {
    this.animations.push(new _helpers_animate_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      func: () => {
        this.drawScene();
      },
      duration: `infinite`,
  ...
  initPlaneAnimations() {
    this.animations.push(new _helpers_animate_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      ...
      duration: 500,
      delay: 400,
      easing: _helpers_easings_js__WEBPACK_IMPORTED_MODULE_2__["default"].easeInQuad
    }));
  }
  ...
  initSeaCalfAnimations() {
    this.animations.push(new _helpers_animate_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      ...
      duration: 2000,
      delay: 200,
      easing: _helpers_easings_js__WEBPACK_IMPORTED_MODULE_2__["default"].easeOutElastic
    }));
...
/* harmony import */ var _modules_letters_anim_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/letters-anim.js */ "./source/js/modules/letters-anim.js");
// modules
...
Object(_modules_letters_anim_js__WEBPACK_IMPORTED_MODULE_10__["default"])();
